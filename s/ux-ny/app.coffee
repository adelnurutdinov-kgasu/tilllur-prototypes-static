...
cutTop = new Layer
	...
	width: 375.0, height: 1208.0, image: "images/cut_top.png"
...
resultView_Image.states =
	"init": { opacity: 0 }
	"done": { opacity: 1 }
resultView_Image.stateSwitch("init")

resultView_Image.onTouchStart ->
